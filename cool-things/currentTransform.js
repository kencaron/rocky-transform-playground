//Ken Caron: Ripped and slightly gutted from https://github.com/goessner/canvas-currentTransform
/**
...
//(()=> {
	console.log('reading currentTransformjs');
	
	function makePolyfills(CanvasRenderingContext2D) {
		console.log(`making polyfills from CanvasRenderingContext2D ${CanvasRenderingContext2D}`);
		console.log(`PROTOTYPE IS ${JSON.stringify(CanvasRenderingContext2D)}`);
		...
		if (!("currentTransform" in CanvasRenderingContext2D.prototype)) {
			 ...
			 */
			// fully implement it ... hmm ... 'currentTransform', 'save()', 'restore()', 'transform()', 'setTransform()', 'resetTransform()'
			Object.defineProperty(CanvasRenderingContext2D.prototype, "currentTransform", {
				get         : function () {
					return this._t2stack && this._t2stack[this._t2stack.length - 1] || {a: 1, b: 0, c: 0, d: 1, e: 0, f: 0};
				},
				set         : function (x) {
					if (!this._t2stack)
						this._t2stack = [{}];
			...
			CanvasRenderingContext2D.prototype.transform      = function () {
				...
				return function (a, b, c, d, e, f) {
					...
					q     = t.a;
					t.a = a * q + c * t.b, t.b = b * q + d * t.b;
					q = t.c;
					t.c = a * q + c * t.d, t.d = b * q + d * t.d;
					q   = t.e;
					t.e = a * q + c * t.f + e;
					t.f = b * q + d * t.f + f;
