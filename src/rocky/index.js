...
rocky.on('draw', function (event) {
	...
	ctx.scale = function (sx, sy) {
		...
		//This used to work but now causes an app fault?
		this._transform = multiplyTransform(this._transform, [sx, 0, 0, sy, 0, 0]);
		console.log('we did the multiplyTransform. Now what?');
		console.log('Manually edit every method? What about members like lineWidth? my brain hurts.');
	};
	...
	var multiplyTransform = function multiplyTransform(t1, t2) {
